...
(function($){
	$.fn.dcAccordion = function(options) {
		...
		var defaults = {
			...
			cookie  : 'dcjq-accordion'//default dcjq-accordion Sets the cookie name for saving menu state - each menu instance on a single page requires a unique cookie name.
		};
